...
@section("title")
    ...
    @if(\Illuminate\Support\Str::length($tag->seo_description) > 1)
        <meta property="og:site_name" content="{{ $tag->seo_description }}">
    @endif
    <meta property="og:image" content="{{ request()->getSchemeAndHttpHost() . '/img/uploads/tag/' . $tag->image ?? '/img/home/logo.png'}}">
@endsection
