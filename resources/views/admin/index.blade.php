...
<head>
  ...
  <title>ادمین - تهاتر ایرانیان</title>
  ...
  <!-- Custom styles for this template-->
    <link href="{{url('admin/css/sb-admin-2.min.css')}}" rel="stylesheet" type="text/css">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="{{url('/admin/img/undraw_posting_photo.svg')}}" alt="">
                  </div>
