                                    ...
                                    <div class="item">
                                        <div style="min-height: 200px;" class="row justify-content-center align-items-center">
                                            @if(is_null($product->thumbnail))
                                                <img src="/thumbnails/no-thumbnail2.png" alt="BTI" class="img-fluid">
                                            @else
                                                <img src="/uploads/thumbnail/{{$product->thumbnail}}" alt="CioCe.ir / {{$product->thumbnail}}" class="img-fluid">
                                            @endif
                                        </div>
                                    </div>
