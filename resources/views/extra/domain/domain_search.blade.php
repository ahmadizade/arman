                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="content-faq-question">
                                            <p class="text-justify">همچنین در این بخش می توانید ایمیل های اصلی سایت جستجو شده را ببینبد و متوجه شوید که این ایمیل ها در چه سایت هایی عضو هستند، درواقع شما متوجه ارتباطات آن سایت با دیگر وب سایت ها و کمپانی ها می شوید، اینجوری تو هم می تونی از اون سایت ها و روابط اونا برای رشد کسب و کار خودت استفاده کنی.</p>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="content-faq-question">
                                            <img src="/img/theme/domain-names-2.jpg">
