<div style="border: 1px solid #ccc;padding: 20px;box-sizing: border-box;margin: 25px 0;box-shadow: 0 15px 10px -10px #ccc;">
    <p style="text-align: center"><img style="max-width: 100%" src="http://armanmask.ir/img/icon/mosalas-200.png" alt="armanmask LOGO"></p>
    <h1 style="margin: 35px 0 0 0;text-align: center;font-size: 15px;font-family: tahoma">جهت تایید ایمیل خود در وب سایت فروشگاه آرمان روی لینک زیر کلیک کنید</h1>
