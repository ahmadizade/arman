...
class PaymentController extends Controller
{
    ...
    public static function payment($id,$amount)
    {
    ...
    public static function paymentCart($id,$amount)
    {
        ...
        if ($err) {
            ...
            if (empty($result['errors'])) {
                ...
                if ($result['data']['code'] == 100 && $result['data']['message'] == "Success") {
                    ...
                    return Response::json(['status'=>'1', 'result' => "https://www.zarinpal.com/pg/StartPay/" . $result['data']['authority']]);
            ...
            if(isset($checkPayment->id) && $checkPayment->status == "PENDING"){
                ...
                if (empty($result['errors'])) {
                    if(isset($result['data']) && ($result['data']['code'] == 100 || $result['data']['code'] == 101) && Str::length($result['data']['ref_id']) > 2){
                        ...
                        DB::table("orders")->where("user_id",Auth::id())->where("bank_token",$ref)->update([
                            "status_payment" => "PAID",
                        ...
                        return Redirect::route("shopping_complete",['ref' => $ref]);
